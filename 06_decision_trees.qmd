...
::: {.justify}
![Decision Tree for YoY Inflation Prediction](results/5_Decision_Trees/decision_tree_inf_YoY.jpg){#fig-inf-YoY-dt fig-align="center" width="100%"}
:::
...
::: {.justify}
![Decision Tree for MoM Inflation Prediction](results/5_Decision_Trees/decision_tree_inf_MoM.jpg){#fig-inf-MoM-dt fig-align="center" width="100%"}
:::
...
::: {.justify}
![Decision Tree for Unemployment Rates Prediction](results/5_Decision_Trees/decision_tree_unemp.jpg){#fig-unemp-dt fig-align="center" width="100%"}
:::
